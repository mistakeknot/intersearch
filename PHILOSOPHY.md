...
## North Star
Advance intersearch through small, testable changes aligned to its core mission: Shared embedding and search infrastructure for the Interverse ecosystem — sentence-transformer embeddings and Exa web search.
